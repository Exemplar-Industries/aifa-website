  ...
  return (
    <main className="events-page" style={{ minHeight: "100vh", overflowX: "hidden", background: "#080808", color: "#F5F5F0", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <style>{`
        ...
        .events-title span:last-child, .events-heading span { color: var(--afa-red); }
        ...
        .event-date { color: var(--afa-red); font-size: 1rem; font-weight: 800; line-height: 1.35; margin: 0 0 .8rem; }
        ...
        .event-source { display: inline-block; color: var(--afa-red); font-size: 1rem; font-weight: 800; margin-top: 1rem; text-decoration: none; }
      ...
      <section style={{ padding: "clamp(6.5rem, 12vw, 10rem) 1.5rem clamp(4rem, 8vw, 6.5rem)", background: "radial-gradient(ellipse at 88% 16%, color-mix(in srgb, var(--afa-red) 32%, transparent), transparent 40%), #080808", borderBottom: "1px solid rgba(255,255,255,.1)" }}>
