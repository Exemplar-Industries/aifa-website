...
const cameraSlides: CameraSlide[] = [
  ...
  { label: "Tracking", title: "Tracking", copy: "Momentum. Pursuit. A subject moving through the world.", detail: "The camera physically follows the subject as it travels.", prompt: "Tracking shot following the car as it drives away down the motel road." },
...
const learningObjectivesSlides: FreeTrainingSlide[] = [
  ...
  { label: "The path", title: "A four-week system", copy: "The core curriculum follows a repeatable path through preproduction, production, and postproduction." },
  { label: "01 · Workflow", title: "Use the full workflow", copy: "Choose image-generation, video-generation, and editing tools—and use them in the right sequence to finish a project." },
  { label: "02 · Story", title: "Build a short story", copy: "Write a 30 to 60 second concept with a clear progression, emotional payoff, and call to action when appropriate." },
  ...
  { label: "10 · Present", title: "Export your work", copy: "Export at 1080p or higher in the right horizontal or vertical format, then select strong projects for a portfolio." },
  { label: "Practical demonstration", title: "Make a full sequence", copy: "Demonstrate the process through a character sheet, an ordered storyboard, and a finished 30 to 60 second video with intentional choices." },
  { label: "Further learning", title: "Keep learning", copy: "Bonus lessons explore commercial hooks, real product integration, portfolio pitching, pricing, scope, revisions, client delivery, visual effects, and soundtrack design." },
  { label: "AI Video Specialist", title: "Finish with proof", copy: "Complete the course and certification, pair it with a finished portfolio, and show clients or employers what you can apply on real projects." },
];
